...
def replace_and_save_html(source_file, keyword_file, output_folder):
    ...
    for keyword in keywords:
        ...
        replaced_html = replaced_html.replace('1 GB+', f'{random.uniform(1, 2.6):.2f} GB')
        ...
        for _ in range(10):
            ...
            link_tags += f'<a href="https://fanswish.co/onlyfans/{random_username}">{random_username} Onlyfans Leaks</a><br>\n'
